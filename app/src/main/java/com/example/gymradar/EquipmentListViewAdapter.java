...
public class EquipmentListViewAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView tvName = (TextView)view.findViewById(R.id.eq_name);
        TextView tvCount = (TextView)view.findViewById(R.id.eq_count);
        ...
        tvCount.setText(Integer.toString(listdata.getCount())); //원래 int형이라 String으로 형 변환
